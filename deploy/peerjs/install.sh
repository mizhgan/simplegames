...
ExecStart=$NODE_BIN $APP_DIR/node_modules/peer/dist/bin/peerjs.js --host 0.0.0.0 --port $PORT --path / --sslkey $CERT_DIR/privkey.pem --sslcert $CERT_DIR/fullchain.pem --alive_timeout 60000 --expire_timeout 5000 --concurrent_limit 5000
Restart=always
RestartSec=3
