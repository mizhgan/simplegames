...
(() => {
  ...
  const GAMES = {
    ...
    simon: 'Саймон',
    hangman: 'Виселица',
    wordsmith: 'Слова из слова',
    gomoku: 'Гомоку',
    dots: 'Точки и квадраты',
    ...
    sokoban: 'Сокобан',
    kakuro: 'Какуро',
    killer: 'Киллер-судоку',
    frogger: 'Лягушка',
    invaders: 'Космические захватчики',
    asteroids: 'Астероиды',
    eggs: 'Яйцелов',
    tanks: 'Танчики',
    chess: 'Шахматы',
    uttt: 'Ultimate крестики-нолики',
    quarto: 'Кватро',
    ugolki: 'Уголки',
    mill: 'Мельница',
    mancala: 'Манкала',
    ...
    go: 'Го 9×9',
    erudit: 'Эрудит',
    wordduel: 'Дуэль в Вордли',
    cities: 'Города',
    crocodile: 'Крокодил-рисовалка',
    thousand: 'Тысяча',
    seka: 'Сека',
    war: 'Пьяница',
    holdem: 'Покер: холдем',
    tron: 'Трон',
    airhockey: 'Аэрохоккей',
    tankduel: 'Танчики вдвоём',
    bomber: 'Бомбермен-дуэль',
    capture: 'Точки: захват',
    pentago: 'Пентаго',
    blokus: 'Блокус',
    stratego: 'Стратего',
    domino: 'Домино',
    lotto: 'Русское лото',
    wordrace: 'Слова из слова: дуэль',
    bulls: 'Быки и коровы',
    hangduel: 'Виселица вдвоём',
    snakeduel: 'Змейки-дуэль',
    tetrisduel: 'Тетрис-баттл',
    billiards: 'Бильярд',
    soccer: 'Мини-футбол',
    racing: 'Гонки',
    ...
    spy: 'Шпион',
    dixit: 'Ассоциации',
    crocoparty: 'Крокодил для компании',
    pokerparty: 'Покер на компанию',
    durakparty: 'Дурак на компанию',
    maumau: 'Мау-мау',
    quiz: 'Викторина',
    codenames: 'Кодовые слова',
    uno: 'Уно',
    magnat: 'Магнат',
    eruditparty: 'Эрудит на компанию',
    whoami: 'Кто я?',
    resistance: 'Сопротивление',
    conspiracy: 'Заговор',
    twotruths: 'Правда или ложь',
    hat: 'Шляпа',
    bunker: 'Бункер',
    bingo: 'Бинго',
    dice1000: 'Тысяча на костях',
    tournament: 'Турнир',
    pig: 'Свинья',
    ur: 'Королевская игра Ура',
    hasami: 'Хасами-сёги',
    abalone: 'Абалон',
    blindmaze: 'Лабиринт вслепую',
    backgammon: 'Короткие нарды',
    crossduel: 'Кросс-ворд батл',
